...
def _get_or_create_state(db: Session, user_id: str, provider: str = "outlook") -> models.MailboxSyncState:
    state = (
...
def initial_outlook_import(
    ...
    *,
    ...
    """
    state = _get_or_create_state(db, user_id=user_id, provider="outlook")
